...
//  ros::service::waitForService("arm_kinematics/get_fk_solver_info");
//  ros::service::waitForService("arm_kinematics/get_fk");
//  ros::ServiceClient query_client =
//      rh.serviceClient<kinematics_msgs::GetKinematicSolverInfo> ("arm_kinematics/get_fk_solver_info");
//  ros::ServiceClient fk_client = rh.serviceClient<kinematics_msgs::GetPositionFK> ("arm_kinematics/get_fk");

  ros::service::waitForService("kurtana_arm_kinematics/get_fk_solver_info");
  ros::service::waitForService("kurtana_arm_kinematics/get_fk");
  ros::ServiceClient query_client =
      rh.serviceClient<kinematics_msgs::GetKinematicSolverInfo> ("kurtana_arm_kinematics/get_fk_solver_info");
  ros::ServiceClient fk_client = rh.serviceClient<kinematics_msgs::GetPositionFK> ("kurtana_arm_kinematics/get_fk");
